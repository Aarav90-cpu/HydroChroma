...
***Check out the wiki for the [Documentation](https://github.com/Aarav90-cpu/HydroChroma/wiki/1.-Get-Started)***
...
```
	dependencies {
	        implementation 'com.github.Aarav90-cpu:HydroChroma:<VERSION>'
	}
```
